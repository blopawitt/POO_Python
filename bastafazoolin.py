...
class Franchise:
  ...
  def __repr__(self):
    return ("The franchise is located on {}".format(self.address))
...
print(new_installment.available_menus(2000))
...
last_business = Business("Take a Arepa",arepas_place)
